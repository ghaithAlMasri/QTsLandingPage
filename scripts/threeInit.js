...
class ThreeInit {
  ...
  init() {
    ...
    this.loader.load('/shirt_baked.glb', function (gltf) {
      ...
      logo.name = 'logo'
      logo.position.set(-0.11, self.logoY, self.logoZ);
      logo.scale.set(self.logoScaler, self.logoScaler, self.logoScaler);
      ...
      myObject.position.x = (self.sizes.width < 450) ? 0.12 : 0.03
